...
$template_2 = function($lang,$refugee, $serviceDate, $timeFrom, $timeTo, $devHead, $sheetCreater)
{
    $thisDate= date("d.m.Y");
    ...
    $pdfBody.='<div class="container">
                <div class="content">
                        <table class="table_header">
                            <tr>
                                <td></td>
                                <td><img src="templates/logo/2.svg" class="logo_img" alt=""></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>Interpreter\'s centre Of Armenia Red Cross Society</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>"Հայկական կարմիր խաչի ընկերության" Թարգմանությունների կենտրոն</td>
                                <td></td>
                            </tr>
                        </table>
                        <p class="text_center">Request for Interpretation/Translation Service</p>
                        <p class="text_center">Բանավոր թարգմանչական ծառայությունների տրամադրման խնդրագիր</p>
                        <table class="table__one">
                            ...
                            <tr>
                                ...
                                <td class="tableone_content">'.$lang.',բանավոր/ հարցազրույց / <span class="little_font">'.$refugee.'Ի հետ</span></td>
                            </tr>
                        </table>
                        ...
                        <table class="table_three">
                            ...
                            <tr>
                                <td class="tablethree_title">Ծառայության տրամադրման ակնկալվող տևողությունը</td>
                        ...
                        <table class="unhcr">
                            <tr>
                                <td class="first_td">This project financed by UNHCR</td>                               
                                <td rowspan="2" second_td><img src="templates/logo/UNHCR.png" class="unhcrImage"/></td>
                            </tr>
                            <tr>
                                <td class="third_td">Ծրագիրն իրականացվում է ՄԱԿ ՓԳՀ-ի ֆինանսավորմամբ</td>
                            </tr>
                        </table>
