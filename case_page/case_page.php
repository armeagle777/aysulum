...
<div id="functions" class="tabcontent">
    ...
    <div class="col-md-12">
      <div class="row">
      <div class="col-md-6">
       <h5 class="sub_title">Գործի կարգավիճակ </h5> 
       <table class="table">
              <tr>
               ...
               <tr>
                <th class="table_a">Ընթացքի կարգավիճակ</th>
                <td><input type="text" name="case_num" class="form-control form-control-sm"></td>
              </tr>
              <tr>    
      ...
      <div class="col-md-6">
        <h5 class="sub_title">Գործի մանրամասներ </h5> 
              <table class="table">
              <tr>
    ...
    <div class="col-md-12">
      <div class="row">
      <div class="col-md-6">
         <h5 class="sub_title">Ընդունված որոշումներ</h5>
              <table class="table">
              <tr>
                <th class="table_a"> ՄԾ որոշում</th>
                <td><input type="text" name="case_num" class="form-control form-control-sm"></td>
              </tr>
              <tr>  
                <th class="table_a"> ՄԾ որոշման ամսաթիվ</th>
                <td><input type="text" name="case_num" class="form-control form-control-sm"></td>
              </tr>
              <tr>
                <th class="table_a"> Վերջնական որոշում</th>
                <td><input type="text" name="case_num" class="form-control form-control-sm"></td>
              </tr>
              <tr>
                <th class="table_a"> Վերջնական որոշման ամսաթիվ</th>
                <td><input type="text" name="case_num" class="form-control form-control-sm"></td>
              </tr>
