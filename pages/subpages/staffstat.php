...
$sql_staff = "SELECT COUNT(DISTINCT a.case_id) AS COUNT_CASES, COUNT(DISTINCT c.personal_id) AS COUNT_PERSON, b.id, b.username, b.f_name, b.l_name FROM tb_case a INNER JOIN tb_person c ON a.case_id = c.case_id INNER JOIN users b ON a.officer = b.id GROUP BY b.username";
