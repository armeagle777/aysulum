...
<div class="topnav2" id="myTopnav2">
        <div class="dem">
                ...
                <div id="bungie">
                    <ul>
                        <li><a href="?page=cases&homepage=notifications" <?php if($homepage=="notifications"){ ?> class="active active_subpage" <?php } ?> ><i class="fas fa-envelope"></i> Նամականի </a></li>
                        <?php
                            ...
                            {
                        ?>
                                <li><a href="?page=cases&homepage=inbox" <?php if($homepage=="inbox"){ ?> class="active_subpage" <?php } ?> ><i class="fa fa-inbox" aria-hidden="true"></i> Մտից </a>
                        ...
                        <?php
                            ...
                            {
                        ?>
                                <li><a href="?page=cases&homepage=outbox" <?php if($homepage==="outbox"){ ?> class="active_subpage" <?php } ?> ><i class="fa fa-paper-plane" aria-hidden="true"></i> Ելից </a></li>
                        <?php
                            }
                        ?>
                        ...
                        <?php
                            ...
                            {
                        ?>
                                <li><a href="?page=cases&homepage=coi" <?php if($homepage=="coi"){ ?> class="active_subpage" <?php } ?> ><i class="fas fa-info"></i> ԾԵՏ հարցումներ </a></li>
                        <?php
                            }
                        ?>
                        ...
                        <?php
                            ...
                            {
                        ?>
                            <li><a href="?page=cases&homepage=body" <?php if($homepage=="body"){ ?> class="active_subpage" <?php } ?> ><i class="fas fa-envelope-open-text"></i> Հարցումներ </a>
                                <div class="notify_circle">
                        ...
                        <?php
                            ...
                            {
                        ?>
                            <li><a href="?page=cases&homepage=draft" <?php if($homepage=="draft"){ ?> class="active_subpage" <?php } ?> ><i class="fab fa-firstdraft"></i> Նախագծեր </a>
                                <div class="notify_circle">
                        ...
                        ?>
                         ...
                         <?php
                            ...
                            {
                        ?>
                                <li><a href="?page=cases&homepage=orders" <?php if($homepage=="orders"){ ?> class="active_subpage" <?php } ?> > <i class="fas fa-book-open"></i> Ուղեգրեր</a>
                                    <div class="notify_circle">
                        ...
                        <?php
                            ...
                            {
                        ?>
                            <li><a href="?page=cases&homepage=my_cases" <?php if($homepage==="my_cases"){ ?> class="active_subpage" <?php } ?> ><i class="fa fa-tasks" aria-hidden="true"></i> Իմ վարույթում </a></li>
                        <?php
                            }
                        ?>
                        <?php
                            ...
                            {
                        ?>
                            <li><a href="?page=cases&homepage=devcurrent" <?php if($homepage=="devcurrent"){ ?> class="active_subpage" <?php } ?> ><i class="fa fa-tasks" aria-hidden="true"></i> Բաժնի ընթացիկ </a></li>
                        <?php
                            }
                        ?>
                         <?php
                            ...
                            {
                        ?>
                            <li><a href="?page=cases&homepage=bordercross" <?php if($homepage=="bordercross"){ ?> class="active_subpage" <?php } ?> ><i class="fa fa-tasks" aria-hidden="true"></i> Հատուկ գործեր  </a> </li>
                        ...
                        <?php
                            ...
                            {
                        ?>
                            <li><a href="?page=cases&homepage=currentcourt" <?php if($homepage=="currentcourt"){ ?> class="active_subpage" <?php } ?> ><i class="fas fa-balance-scale-right"></i> Ընթացիկ դատական </a></li>
                        <?php
                            }
                        ?>
                        ...
                        <?php
                            ...
                            {
                        ?>
                            <li><a href="?page=cases&homepage=staffstat" <?php if($homepage=="staffstat"){ ?> class="active_subpage" <?php } ?> ><i class="fa fa-tasks" aria-hidden="true"></i> Աշխատակիցներ </a></li>
                        <?php
                            }
                        ?>
                        <?php
                            ...
                            {
                        ?>
                                <li><a href="?page=cases&homepage=aysulum" <?php if($homepage=="aysulum"){ ?> class="active_subpage" <?php } ?> ><i class="fas fa-users"></i> Ապաստան հայցողներ</a></li>
                        <?php
                            }
                        ?>
                        <?php
                            ...
                            {
                        ?>
                                <li><a href="?page=cases&homepage=idstat" <?php if($homepage=="idstat"){ ?> class="active_subpage" <?php } ?> ><i class="fas fa-id-card"></i> Քարտերի վիճակագրություն</a></li>
                        <?php
                            }
                        ?>
                        ...
                        <?php
                            ...
                            {
                        ?>
                                <li><a href="?page=cases&homepage=rooms" <?php if($homepage=="rooms"){ ?> class="active_subpage" <?php } ?> > <i class="far fa-building"></i> Կացարան</a></li>
                        <?php
                            }
                        ?>
                        ...
                        <?php
                            ...
                            {
                        ?>
                                <li><a href="?page=cases&homepage=new_case" style="color: green;"><i class="fa fa-plus" aria-hidden="true"></i> Նոր գործ</a></li>
                        <?php
                            }
                        ?>
                    </ul>
